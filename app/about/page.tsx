...
import { BookOpen, Headphones, Github, Bot, Calendar, FileText, Clock, Bookmark, Moon } from "lucide-react"
            ...
            <Card className={cn(isDark && "bg-gray-800 border-gray-700")}>
              <CardContent className="pt-6">
                <div className="flex flex-col items-center text-center">
                  ...
                  >
                    <Calendar className={cn("h-6 w-6", isDark ? "text-emerald-400" : "text-emerald-700")} />
                  </div>
                  <h3 className={cn("text-lg font-semibold mb-2", isDark ? "text-emerald-400" : "text-emerald-800")}>
                    Hijri Calendar
                  </h3>
                  <p className={cn(isDark ? "text-gray-300" : "text-gray-600")}>
                    Track important Islamic dates and events with our integrated Hijri calendar that shows the current
                    Islamic date and month.
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className={cn(isDark && "bg-gray-800 border-gray-700")}>
              <CardContent className="pt-6">
                <div className="flex flex-col items-center text-center">
                  ...
                  >
                    <FileText className={cn("h-6 w-6", isDark ? "text-emerald-400" : "text-emerald-700")} />
                  </div>
                  <h3 className={cn("text-lg font-semibold mb-2", isDark ? "text-emerald-400" : "text-emerald-800")}>
                    Daily Hadiths
                  </h3>
                  <p className={cn(isDark ? "text-gray-300" : "text-gray-600")}>
                    Read authentic hadiths for each day of the week with translations and sources to deepen your
            ...
            <Card className={cn(isDark && "bg-gray-800 border-gray-700")}>
              <CardContent className="pt-6">
                <div className="flex flex-col items-center text-center">
                  ...
                  >
                    <Clock className={cn("h-6 w-6", isDark ? "text-emerald-400" : "text-emerald-700")} />
                  </div>
                  <h3 className={cn("text-lg font-semibold mb-2", isDark ? "text-emerald-400" : "text-emerald-800")}>
                    Prayer Times
                  </h3>
                  <p className={cn(isDark ? "text-gray-300" : "text-gray-600")}>
                    Get accurate prayer times for your location with countdown to the next prayer and customizable
                    settings.
                  </p>
                </div>
              </CardContent>
            ...
            <Card className={cn(isDark && "bg-gray-800 border-gray-700")}>
              <CardContent className="pt-6">
                <div className="flex flex-col items-center text-center">
                  ...
                  >
                    <Bookmark className={cn("h-6 w-6", isDark ? "text-emerald-400" : "text-emerald-700")} />
                  </div>
                  <h3 className={cn("text-lg font-semibold mb-2", isDark ? "text-emerald-400" : "text-emerald-800")}>
                    Digital Tasbih
                  </h3>
                  <p className={cn(isDark ? "text-gray-300" : "text-gray-600")}>
                    Use our digital counter for dhikr and tasbih with multiple preset phrases, counters, and vibration
                    feedback.
                  </p>
                </div>
              </CardContent>
            ...
            <Card className={cn(isDark && "bg-gray-800 border-gray-700")}>
              <CardContent className="pt-6">
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className={cn(isDark ? "text-gray-300" : "text-gray-600")}>
                    Learn how to perform ablution (wudu) and prayer (salah) with our step-by-step visual guide with
            ...
            <Card className={cn(isDark && "bg-gray-800 border-gray-700")}>
              <CardContent className="pt-6">
                <div className="flex flex-col items-center text-center">
                  ...
                  >
                    <Moon className={cn("h-6 w-6", isDark ? "text-emerald-400" : "text-emerald-700")} />
                  </div>
                  <h3 className={cn("text-lg font-semibold mb-2", isDark ? "text-emerald-400" : "text-emerald-800")}>
                    Dark Mode
                  </h3>
                  <p className={cn(isDark ? "text-gray-300" : "text-gray-600")}>
                    Enjoy a comfortable reading experience with our beautiful dark mode that reduces eye strain in
